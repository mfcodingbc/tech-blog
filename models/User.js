...
User.init(
  ...
  {
    hooks: {
    // complex and clunky async function:
      // // set up beforeCreate lifecycle "hook" functionality
      //   beforeCreate(userData) {
      //     // hash function on plaintext password, saltRound value, passed to Promise object which is returned and the function ends
      //     return bcrypt.hash(userData.password, 10).then(newUserData => {
      //       return newUserData
      //     });
      //   }
    // async/await syntax for better legibility:
      // set up beforeCreate lifecycle "hook" functionality
